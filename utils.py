...
def unmold_mask(mask, bbox, image_shape, i=None):
    ...
    #TODO: Check the bounding box coordinates and assert that y1 < y2 and x1 < x2.
    try:    
        mask = skimage.transform.resize(mask, (y2 - y1, x2 - x1), order=1, mode="constant")
    except:
        print("Warning for mask number: {}".format(i))
